...
Image classification models detailed in the [previous blog post](https://medium.com/comet-app/review-of-deep-learning-algorithms-for-image-classification-5fdbca4a05e2) classify images into a single category, usually corresponding to the most salient object. However, photos taken with mobile phones are usually complex and contain multiple objects. In this case, such models are uncertain about which label to assign. An object detection model is therefore more appropriate to identify multiple important objects in a single image. Moreover, it provides  the localization of the objects on the image.
...
![41_R_FCN_blog](41_R_FCN_blog.PNG)*The input image feeds a ResNet model to produce feature maps. A RPN model detects the Region of Interests and a score is computed for each region to determine the most likely object if there is one. Source: [J. Dai and al. (2016)](https://arxiv.org/pdf/1605.06409.pdf)*
...
![42_baby_ex](42_baby_ex.PNG)*Source: [J. Dai and al. (2016)](https://arxiv.org/pdf/1605.06409.pdf)*
...
The YOLO model [(J. Redmon et al., 2016)](https://arxiv.org/pdf/1506.02640.pdf)) directly predicts bounding boxes and class probabilities with a single network in a single evaluation. The simplicity of the YOLO model allows real-time predictions. 
...
^5: Details are provided in the [previous blog post](https://medium.com/comet-app/review-of-deep-learning-algorithms-for-image-classification-5fdbca4a05e2).